...
vectorStore.addExpense = async (json, incomingQuery) => {
  ...
  const embedding_text = `Category: ${json.category.toUpperCase()}. Subcategories: ${json.subCategory.join(
    ", "
  )}. Amount: ₹${json.amount}. Purpose: ${
    json.description || "General Expense"
  }. Date: ${json.createdAt.toISOString()}.`;
